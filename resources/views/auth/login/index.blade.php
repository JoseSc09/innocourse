<x-app-layout>
    <div class="container flex flex-col max-w-full md:flex-row justify-between bg-[#e0d4fd]">
        <section class="left mx-full flex-1 max-w-1/2 md:max-w-1/2">
            ...
            <div class="relative  bottom-20 left-12 z-20 w-full md:w-[550px] md:bottom-40 md:left-48">
                ...
                <a href="{{ route('register.index') }}"
                    class="absolute bottom-5 left-[200px] bg-black text-white font-bold py-2 px-4 rounded-3xl z-30 md:left-[240px] md:bottom-5 md:ml-60.5 md:px-5">Registrate</a>
            </div>
        </section>
        <section class="right flex-1 max-w-xl md:max-w-full bg-[#e0d4fd] flex flex-col items-center mb-20">
            ...
            <form id="loginForm" class="flex flex-col ml-0 justify-center mt-8 w-150 gap-4 md:w-2/3"
                action="{{ route('validate') }}" method="POST">
                @csrf
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" placeholder="Ingrese su correo electrónico"
                        required class="w-full p-2 border-none rounded-3xl text-base mb-2 md:w-full">
                </div>
                <div>
            ...
            <div class="centered flex flex-col items-center w-1/2 ml-20 md:ml-0 md:w-full md:mt-4">
                <p class="mt-1 mb-2">¿Aun no tienes cuenta?</p>
                <a href="{{ route('register.index') }}" class="rigth-blue-button text-blue-500">Registrate</a>
            </div>
        </section>
    </div>
</x-app-layout>
