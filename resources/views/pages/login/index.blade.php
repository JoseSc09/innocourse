<x-app-layout>
    ...
    <section class="left mx-full flex-1 max-w-1/2 md:max-w-1/2"> 
        ...
        <div class="relative  bottom-20 left-12 z-20 w-full md:w-[550px] md:bottom-40 md:left-48">
            <p class="bg-[#e0d4fd] text-black font-bold rounded-3xl inline-block pt-[15px] pr-[140px] pb-[15px] pl-[5px] ">¿Aun no eres parte de <br>esta comunidad?</p>
            <button onclick="window.location.href='//9000-idx-innocourse-1724657250495.cluster-duylic2g3fbzerqpzxxbw6helm.cloudworkstations.dev/register?monospaceUid=472243&embedded=0'" 
    ...
    <h2 class="text-white text-4xl font-bold text-center mt-8 p-4 rounded-lg md:text-3xl" style="-webkit-text-stroke: 2px black;">¡Bienvenid@ de vuelta!</h2>
    <form id="registerForm" class="flex flex-col ml-0 justify-center mt-8 w-150 gap-4 md:w-2/3">
        ...
        <div>
            ...
            <input type="password" id="confirmPassword" placeholder="Confirme su contraseña" required class="w-full p-2 border-none rounded-3xl text-base mb-0 md:w-full">
        </div>
        <div class="mb-4">
        <a href="https://9000-idx-innocourse-1724657250495.cluster-duylic2g3fbzerqpzxxbw6helm.cloudworkstations.dev/register?monospaceUid=472243&embedded=0" class="botom-blue-one text-blue-500 md:mb-2 ">Crea o Recupera tu contraseña</a>
        </div>
    </form>

        
        <div class="rigth-black-button flex justify-center">
            <button type="submit" class="bg-black text-white text-lg border-none rounded-3xl cursor-pointer py-2 px-6 mb-2 w-80 md:w-20%">Iniciar Sesion</button>
        </div>
        <div class="centered inline-block flex flex-col items-center w-1/2 ml-20 md:ml-0 md:w-full md:mt-4">
            ...
            <a href="https://9000-idx-innocourse-1724657250495.cluster-duylic2g3fbzerqpzxxbw6helm.cloudworkstations.dev/register?monospaceUid=472243&embedded=0" class="rigth-blue-button text-blue-500">Registrate</a>
        </div>
    </section>
</div>
</x-app-layout>