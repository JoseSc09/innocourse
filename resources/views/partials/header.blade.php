<nav class="bg-slate-800 py-4 px-4 md:px-8 text-gray-200 flex flex-col md:flex-row items-center gap-6 md:justify-between text-lg md:text-xl font-semibold">
        ...
        <div id="nav-menu" class="hidden md:flex flex-col md:flex-row items-center w-full md:w-auto">
            <ul class="flex flex-col md:flex-row gap-6 md:gap-8 w-full md:w-auto text-center md:text-left">
                <li>
                    <a class="hover:text-white transition-colors duration-300 text-center" href="{{ route('home.index') }}">Inicio</a>
                </li>
                <li>
                    <a class="hover:text-white transition-colors duration-300 text-center" href="{{ route('courses.index') }}">Cursos</a>
                </li>
                <li>
                    <a class="hover:text-white transition-colors duration-300 text-center" href="{{ route('about.index') }}">Sobre Nosotros</a>
                </li>
                <li>
                    <a class="hover:text-white transition-colors duration-300 text-center" href="{{ route('opinions.index') }}">Opinión</a>
                </li>
            </ul>
        </div>
